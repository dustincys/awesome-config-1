...
theme.cf_appswitcher = { font = "Play", size = 18, face = 1 } -- application switcher font
...
theme.widget.tasklist.appnames["Evolution"           ] = "EVL"
